    ...
    def create_data_analysis_agent(self) -> Agent:
        ...
        return self._create_base_agent(
            ...
            instructions=[
                ...
                "",
                "**CRITICAL - READ THE DATA PROVIDED:**",
                "The user prompt contains ACTUAL DATA in a table format under 'Data Sample'.",
                "You MUST analyze this specific data, not provide generic analysis.",
                "Reference SPECIFIC dates, values, and statistics from the provided data.",
                "",
                "**Your Analysis Must Include:**",
                "1. Data range analysis - mention the SPECIFIC start and end dates from the data",
                "2. Value trends - reference ACTUAL values and their patterns (e.g., 'values range from 234.5 to 1,245.8')",
                "3. Statistical summary - use the provided statistics (mean, median, std dev, min, max)",
                "4. Missing values or gaps - identify any issues in the ACTUAL data shown",
                "5. Seasonality or patterns - based on the ACTUAL dates and values provided",
                "6. Anomalies - point out specific unusual values in the data",
                "",
                "**What NOT to do:**",
                "- Do NOT say 'I need data to analyze' when data is provided",
                "- Do NOT give generic advice like 'you should collect data'",
                "- Do NOT make up statistics or values not in the provided data",
                "",
    ...
    def create_forecasting_agent(self, agent_type: str = "General") -> Agent:
        ...
        if agent_type == "Short Term Forecasting":
            instructions = [
                ...
                "The user prompt contains ACTUAL HISTORICAL DATA in a table format.",
                "You MUST analyze this specific data to generate forecasts.",
                "Reference SPECIFIC recent values and trends from the provided data.",
                "Base your forecasts on the ACTUAL patterns visible in the data.",
                "",
            ...
            instructions = [
                ...
                "The user prompt contains ACTUAL HISTORICAL DATA in a table format.",
                "You MUST analyze this specific data to generate forecasts.",
                "Identify ACTUAL seasonal patterns, growth trends from the provided data.",
                "Base your long-term projections on the REAL historical patterns shown.",
                "",
            ...
            instructions = [
                ...
                "The user prompt contains ACTUAL HISTORICAL DATA in a table format.",
                "You MUST analyze this specific data to generate forecasts.",
                "Reference SPECIFIC values, dates, and patterns from the provided data.",
                "Do NOT give generic forecasts - use the ACTUAL historical data shown.",
                "",
