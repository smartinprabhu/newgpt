...
"[project]/src/lib/business-question-router.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ __turbopack_context__.s({
    "BusinessQuestionRouter": (()=>BusinessQuestionRouter),
    "businessQuestionRouter": (()=>businessQuestionRouter)
});
class BusinessQuestionRouter {
   ...
   */ route(question, context) {
        ...
        if (this.isDecisionQuestion(lowerQuestion)) {
            return {
                ...
                hints: [
                    'provide_actionable_decisions',
                    'use_forecast_data',
                    'include_costs_and_timelines'
                ],
                requiresContext: [
                    'forecast_results',
                    'actual_data',
   ...
   */ isForecastInterpretation(question) {
        const patterns = [
   ...
   */ hasRequiredContext(routing, context) {
        const missing = [];
   ...
   */ generateMissingContextMessage(missing) {
...
const businessQuestionRouter = new BusinessQuestionRouter();
...
//# sourceMappingURL=src_lib_business-question-router_ts_fca2736b._.js.map