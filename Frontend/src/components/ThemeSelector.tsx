                ...
                >
                  <div className="w-full h-full p-1">
                    <div className={cn(
                      ...
                      {/* Upper left - light red */}
                      <div className={cn(
                        "w-1/2 h-1/2",
                        themeMode === 'dark' ? "bg-red-900" : "bg-red-50"
                      )}></div>
                      {/* Upper right - lighter red */}
                      <div className={cn(
                        "w-1/2 h-1/2",
                        themeMode === 'dark' ? "bg-red-800" : "bg-red-100"
                      )}></div>
                      {/* Lower left - dark red */}
                      <div className={cn(
                        "w-1/2 h-1/2",
                        themeMode === 'dark' ? "bg-red-200" : "bg-red-600"
                      )}></div>
                      {/* Lower right - darker red */}
                      <div className={cn(
                        "w-1/2 h-1/2",
                        themeMode === 'dark' ? "bg-red-100" : "bg-red-200"
                      )}></div>
                    </div>
                    {colorTheme === "red" && (
