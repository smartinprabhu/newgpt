...
import { Dialog, DialogContent, DialogDescription, DialogFooter, DialogHeader, DialogTitle } from "@/components/ui2/dialog";
...
export default function AiGroupingDialog({ open, onOpenChange }: AiGroupingDialogProps) {
