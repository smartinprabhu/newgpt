                                                  ...
                                                  <div key={field.name} className={field.type === 'textarea' ? 'md:col-span-2 mb-2' : 'mb-3'}>
                                                    ...
                                                    {field.type === 'select' ? (
                                                      ...
                                                      <Input
                                                        ...
                                                        onChange={(e) => handleFormInputChange(field.name, e.target.value)}
                                                        className="bg-slate-700 w-full border-slate-600 text-white placeholder:text-slate-400"
                                                      />
                                                    )}
                                                  </div>
                                                ))}
...
export default function CapacityInsightsPageV2({ navigateSimulator, businessId, whatIfDetails }) { // Renamed component
