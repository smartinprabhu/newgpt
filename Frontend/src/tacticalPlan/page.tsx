...
import { HeaderSection } from "./planComponents/capacity-insights/header-section";
import { CapacityTable } from "./planComponents/capacity-insights/capacity-table";
import { initialMockRawCapacityData } from "./planComponents/capacity-insights/data";
...
// Volume & Backlog Model Component 
function VolumeBacklogModelView({ navigateSimulator, whatIfDetails, businessId }) {
  ...
  const [selectedModel, onSelectModel] = useState("volume-backlog");
...
// Main Page Component with Model Switching
export default function HomePage({ navigateSimulator, whatIfDetails, businessId }) {
    ...
    <div className="flex flex-col h-screen bg-background">
     { /* <ModelTabs 
      ...
      <div className="flex-1 overflow-hidden">
        <VolumeBacklogModelView whatIfDetails={whatIfDetails} navigateSimulator={navigateSimulator} businessId={businessId} />
      </div>
    </div>
  );
}
