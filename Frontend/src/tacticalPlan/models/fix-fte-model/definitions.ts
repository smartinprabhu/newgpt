...
export const FIX_FTE_TEAM_METRIC_DEFINITIONS: MetricDefinition[] = [
  ...
  { key: "requiredFTE", label: "Required FTE", isHC: true, isDisplayOnly: true, category: 'PrimaryHC', description: "Calculated FTE needed using simplified methodology." },
  ...
  { key: "overUnderHC", label: "Over/Under FTE", isHC: true, isDisplayOnly: true, category: 'PrimaryHC', description: "Difference: Actual/Starting HC - Required FTE." },
...
export const FIX_FTE_AGGREGATED_METRIC_DEFINITIONS: MetricDefinition[] = [
  ...
  { key: "requiredFTE", label: "Required FTE", isHC: true, description: "Aggregated required FTE from child entities." },
...
export const FIX_FTE_MODEL_DEFINITIONS: ModelMetricDefinitions = {
  teamMetrics: FIX_FTE_TEAM_METRIC_DEFINITIONS,
  aggregatedMetrics: FIX_FTE_AGGREGATED_METRIC_DEFINITIONS
};